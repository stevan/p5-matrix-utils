...
subtest 'sum method - basic summation' => sub {
    ...
    my $v2 = Vector->new( size => 4, data => [ 10, 20, 30, 40 ] );
...
subtest 'dot_product method - basic dot product' => sub {
    ...
    my $v3 = Vector->new( size => 2, data => [ 2, 3 ] );
    my $v4 = Vector->new( size => 2, data => [ 1, 4 ] );
...
subtest 'dot_product method - orthogonal vectors' => sub {
    my $v1 = Vector->new( size => 2, data => [ 1, 0 ] );
    my $v2 = Vector->new( size => 2, data => [ 0, 1 ] );

    # 1*0 + 0*1 = 0
    is( $v1->dot_product($v2), 0, 'dot product of orthogonal vectors is 0' );

    my $v3 = Vector->new( size => 3, data => [ 1, 1, 0 ] );
    my $v4 = Vector->new( size => 3, data => [ 0, 0, 1 ] );
